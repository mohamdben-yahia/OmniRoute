...
# -*- coding: utf-8 -*-
"""
Test ALL Windsurf built-in models with automatic configuration detection.
Auto-detects active Windsurf Language Server port and CSRF token.
"""
import sys
import os
import time
...
print('='*70)
print('WINDSURF AUTO-DETECTION & MODEL TEST')
print('='*70)
print()
...
print()
print('[3/3] Starting model tests...')
print()
...
# Save results
output_file = 'windsurf_builtin_models_test_auto.json'
